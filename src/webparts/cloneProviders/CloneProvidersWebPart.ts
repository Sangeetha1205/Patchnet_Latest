...
import * as strings from 'CloneProvidersWebPartStrings';
import CloneProviders from './components/CloneProviders';
import { ICloneProvidersProps } from './components/ICloneProvidersProps';

export interface ICloneProvidersWebPartProps {
  description: string;
}

export default class CloneProvidersWebPart extends BaseClientSideWebPart<ICloneProvidersWebPartProps> {
  ...
  public render(): void {
    ...
    this.context.msGraphClientFactory.getClient()
      .then((_graphClient: MSGraphClient): void => {
        const element: React.ReactElement<ICloneProvidersProps> = React.createElement(
          CloneProviders,
          {
